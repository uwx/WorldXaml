...
static class XamlHelpers
{
    public static void SetUpCompiler(XamlILCompiler compiler, IKnownTypes knownTypes)
    {
        ...
        compiler.Transformers.Insert(insertIndex + 2, new PropertyObjectTransformer(knownTypes.PropertyObject, knownTypes.BindableObject, knownTypes.PropertyGeneric, knownTypes.IXamlBinding, knownTypes.PropertyAttribute));
